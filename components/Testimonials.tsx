      ...
      <Container>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {testimonials.map((t, i) => (
            ...
            >
              <figure className="relative flex h-full flex-col rounded-3xl border border-slate-200/70 bg-white p-6 shadow-soft transition hover:-translate-y-1 hover:shadow-card">
